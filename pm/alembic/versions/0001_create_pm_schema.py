...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("rent_currency", sa.Enum("USD", "EUR", "SRD", name="currency_enum", schema="pm"), nullable=False),
        sa.Column("deposit_amount", sa.Numeric(14, 2), nullable=False, server_default="0"),
        sa.Column("billing_day", sa.Integer, nullable=False),
        sa.Column("status", sa.Enum("draft", "active", "ended", "terminated", name="lease_status", schema="pm"), nullable=False, server_default="draft"),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now()),
        schema="pm",
    )
    ...
    op.create_table(
        ...
        sa.Column("currency", sa.Enum("USD", "EUR", "SRD", name="currency_enum", schema="pm"), nullable=False),
        sa.Column("due_date", sa.Date, nullable=False),
        sa.Column("amount_paid", sa.Numeric(14, 2), nullable=False, server_default="0"),
        sa.Column("status", sa.Enum("due", "partial", "paid", "overdue", "waived", name="charge_status", schema="pm"), nullable=False, server_default="due"),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now()),
        schema="pm",
    )
    ...
    op.create_table(
        ...
        sa.Column("method", sa.Enum("cash", "bank", "other", name="payment_method_enum", schema="pm"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum("open", "in_progress", "on_hold", "resolved", "closed", name="ticket_status", schema="pm"), nullable=False, server_default="open"),
